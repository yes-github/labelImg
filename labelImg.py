...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        # 将右侧中间的标记框放到全局缓存，方便显示总标签数量
        gvar.set_value("label_list", self.label_list)
        ...
        zoom_in = action(get_str('zoomin'), partial(self.add_zoom, 10),
                         'Ctrl+=',
                         'zoom-in', get_str('zoominDetail'), enabled=False)
        # 缩小
        zoom_out = action(get_str('zoomout'), partial(self.add_zoom, -10),
                          'Ctrl+-',
                          'zoom-out', get_str('zoomoutDetail'), enabled=False)
        # 恢复原始大小
        zoom_org = action(get_str('originalsize'), partial(self.set_zoom, 100),
                          'Ctrl+0', 'zoom', get_str('originalsizeDetail'), enabled=False)
        ...
        add_actions(self.menus.file,
                    (open, open_dir, reload_dir, change_save_dir, open_annotation, copy_prev_bounding, self.menus.recentFiles, save, save_format, save_as, close, reset_all, delete_image, quit))
        ...
        self.actions.beginner = (
            open, open_dir, reload_dir, change_save_dir, open_next_image, open_prev_image, verify, save, save_format, None, create, copy, delete, None,
            zoom_in, zoom, zoom_out, fit_window, fit_width, None,
            light_brighten, light, light_darken, light_org)

        self.actions.advanced = (
            open, open_dir, reload_dir, change_save_dir, open_next_image, open_prev_image, save, save_format, None,
